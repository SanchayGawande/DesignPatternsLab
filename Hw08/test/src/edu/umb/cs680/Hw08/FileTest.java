...
public class FileTest {
    ...
    public void verifyFileEqualityA_java() {
        ...
        assertArrayEquals(expected, fileToStringArray(A_java));
    }
    ...
    public void verifyFileEqualityB_java() {
        ...
        assertArrayEquals(expected, fileToStringArray(B_java));
    }
    ...
    public void verifyFileEqualityATest_java() {
        ...
        assertArrayEquals(expected, fileToStringArray(ATest_java));
    }
    ...
    public void verifyFileEqualityBTest_java() {
        ...
        assertArrayEquals(expected, fileToStringArray(BTest_java));
    }
    ...
    public void verifyFileEqualityReadme_md() {
        ...
        assertArrayEquals(expected, fileToStringArray(readme_md));
    }
}
